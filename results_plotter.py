...
class TimeSeriesPlotter(object):
    def __init__(self, testing_data, testing_data_clean, batch_size, seq_length, n_samples,
                    generative_model, n_hidden_py, experiment_path):
    ...
    def plot(self):
        ...
        batch = self.testing_data[idx, :self.seq_length]
        ...
        gen_model = self.generative_model(data=x_, n_hidden=self.n_hidden_py,
                                        n_samples=self.n_samples, seq_length=self.seq_length,
