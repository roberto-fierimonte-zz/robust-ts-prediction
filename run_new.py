...
class RunVAE(object):
    ...
    def train(self):
        ...
        if self.pre_trained:
            ...
            if gen_model.__class__.__name__ == 'RobustARGeneratorMeanFieldPosterior'.format(self.experiment_path):
...
class RunBayesianTimeSeriesVAE(object):
    ...
    def train(self):
        ...
        log_fh = logging.FileHandler(os.path.join(self.path, '{}.log'.format(datetime.now().strftime('%Y-%m-%d_%H:%M:%S'))))
        ...
        logger.info('Variational Bayes with parameters mean_w = {}, cov_w = {}, alpha = {}, beta = {}')
